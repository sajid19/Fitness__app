...
const Exercises = ({exercises , setExercises , bodyPart}) => {
  ...
  const indexFirstExercise = indexLastExercises - exercisePerPage;
  const currentExercise = exercises.slice(indexFirstExercise , indexLastExercises)
